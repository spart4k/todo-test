...
export default new Vuex.Store({
    ...
    data: [
      {
        ...
        color: '#FF5733',
        todos: [
          { id: 'c9e1074c5b3f5e9c9f3a5a3c1e9b0d4', text: 'Купить молоко' },
          { id: 'd3cbbcb3c83b4bfc89a1fc2359ee6a5', text: 'Купить хлеб' },
          { id: 'f0e85c418d4a4802952f7648cf6aade', text: 'Купить яйца' },
          { id: '8f8e5d7c63aa48b284f597f2fba2cbd', text: 'Купить зеленый чай' },
          { id: '7e4f1defd205450183537e52d83a309', text: 'Купить кофе' },
          { id: 'ba75b434bff543e6b2721a9cf9ff6b0', text: 'Купить сахар' },
          { id: 'f8c3b8c4567d4c04bf0f052abda4f016', text: 'Купить печенье' },
          { id: '1e98281e19b54ef84125fec5bc5d610', text: 'Купить фрукты' },
          { id: '7fd8c30b12df4296ba7ad43f73161a76', text: 'Купить овощи' },
          { id: 'f35e52c0db424b5a8ee58cda1d5b5add', text: 'Купить специи' },
        ],
      },
      {
        ...
        color: '#33FF57',
        todos: [
          { id: '5f3b6be42c384d89a60c7fc3e0f4ce9', text: 'Завершить отчет' },
          {
            id: '0c5189eb69f8478dbff7d928c8c60e0',
            text: 'Подготовить презентацию',
          },
          { id: '4e4a6c12c8f24dc49df514dbeb8cd8bf', text: 'Провести собрание' },
          {
      ...
      },
      {
        ...
        todos: [
          ...
          { id: 'ecc2881f5aae421da080a3c8a8d42dc7', text: 'Пробежать 5 км' },
          {
            id: '9a9285424f0643ec85055f1d02c50eeb',
            text: 'Приготовить здоровый ужин',
          },
          { id: '81d14de0daba4fce93bc7046ca99b3f5', text: 'Сделать растяжку' },
          {
            id: '7d5930f8ba454c48b38c24cb45ba0cb4',
            text: 'Пройти 10 000 шагов',
          },
          { id: 'ede41a8b869741af97e17dcb031dbb00', text: 'Пить 2 литра воды' },
          { id: 'c041f0f8519b46549be4623b42897da5', text: 'Сходить на йогу' },
          {
      ...
      },
      {
        ...
        todos: [
          ...
          { id: '1fcafbf1508f4fb8b0976f88fbeed06d', text: 'Прочитать статью' },
          {
      ...
      },
      {
        ...
        todos: [
          ...
          { id: 'ff2c28087a0f46949fafc417bb15cbfe', text: 'Сделать пикник' },
          { id: '478fb6b1c12e482484c320916446d045', text: 'Сходить в кафе' },
          {
  ...
  getters: {},
  mutations: {
    saveNoteChange(state, note) {
      console.log(state, note)
    },
  },
  actions: {
    async saveNote({ commit }, { id, note }) {
      // console.log(id, note, this.state)
      let currentNote = this.state.data.find((el) => el.id === id)
